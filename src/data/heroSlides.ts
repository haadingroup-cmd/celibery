...
export const heroSlides: HeroSlide[] = [
  {
    ...
    primaryCta: { label: "Shop CEL-96S", href: "/products?category=audio" },
  ...
  },
  {
    ...
    primaryCta: { label: "Shop Headphones", href: "/products?category=audio" },
    secondaryCta: { label: "Explore Audio", href: "/products?category=audio" },
  ...
  },
  {
    ...
    primaryCta: { label: "Shop Power Banks", href: "/products?category=power-banks" },
    secondaryCta: { label: "Explore Charging", href: "/products?category=power-banks" },
