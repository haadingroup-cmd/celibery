...
import { formatAed, getCategoryBySlug, getProductBySlug, getRelatedProducts, products } from "@/data/products";
      ...
      <Container>
        ...
        <div className="mt-6 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-5">
            <div>
              <p className="text-xs font-medium tracking-wide text-brand-emerald uppercase">{category?.name}</p>
        ...
        {related.length > 0 && (
          <div className="mt-20 sm:mt-28">
            <h2 className="text-2xl font-semibold tracking-tight text-neutral-900 sm:text-3xl">You might also like</h2>
